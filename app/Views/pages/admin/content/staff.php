...
<div class="w-full mx-auto text-[#505050]">
    <div class="w-full flex items-center justify-between gap-2">
        ...
        <button id="staff-modal-button" class="bg-base-blue hover:bg-base-hover text-white px-4 py-1.5 rounded-md flex items-center space-x-1 transition-colors duration-200">
            <span>+</span><span>Tambah Staff Baru</span>
        </button>
    </div>

    <table class="w-full text-sm mt-5">
        <thead class="text-left border-b border-gray-200">
            <tr class="text-[#969696]">
        ...
        <tbody class="divide-y divide-gray-100" id="staffTableBody">
    ...
    <div id="staffModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50 p-4 py-10">
        <div class="bg-white rounded-lg w-2/3 overflow-y-auto h-[90vh]">
            <!-- Header Modal -->
...
<script>
    ...
    const staffShowModalButton = document.getElementById("staff-modal-button")

    staffShowModalButton.addEventListener("click", function() {
                ...
                row.innerHTML = `
                    <td class="py-2">
                        <img src="${staff.image || '/images/default-avatar.png'}"
                             class="w-[50px] rounded object-cover">
                    </td>
                    <td class="py-2 text-gray-700">${staff.name}</td>
                    <td class="py-2 text-gray-700">${staff.role}</td>
                    <td class="space-x-2 space-y-3">
    ...
    function openStaffModalForEdit(staffData) {
        ...
        document.getElementById("nip-hook").innerHTML = staffData.nip || "";
    ...
    async function deleteStaff(id) {
        ...
        try {
            await Api.post(`/api/admin/staff/delete/${id}`);
    ...
    async function saveStaffData(e) {
        ...
        const nipHook = document.getElementById('nip-hook').innerHTML;
