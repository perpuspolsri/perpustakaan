<div class="px-4 md:px-20 pt-40 w-full flex flex-col gap-4">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mx-auto max-w-7xl mt-3">
        <?php
        ...
        ?>
            <div class="relative h-[300px] w-full hover:bg-bottom transition-all duration-300 ease-in-out bg-[url('<?= $itemArr[0] ?>')] bg-cover bg-center p-3 flex flex-col justify-end text-white gap-3 rounded" style="height: 300px;">
