...
<!-- <div class="px-10 md:px-20 pt-20 w-full flex flex-col md:flex-row justify-center gap-5" id="tentang">
    <div class="border border-gray-300 p-5 pb-8 rounded-md w-full md:w-4/5 flex flex-col gap-3">
        <h2 class="text-[var(--primary)] text-xl font-bold">Tentang Kami</h2>
        <p class="text-justify leading-5">UPT Perpustakaan Politeknik Negeri Sriwijaya (Polsri) menjadi pusat informasi dan pengetahuan yang mendukung pendidikan, penelitian, dan pengabdian masyarakat melalui layanan modern dan mudah diakses. Dengan koleksi lengkap, sistem digital terintegrasi, serta fasilitas nyaman dan inklusif, kami berkomitmen menciptakan lingkungan belajar yang inspiratif dan terbuka bagi seluruh pengguna di era digital.</p>
        <button class="bg-[var(--primary)] w-fit py-2 px-5 rounded text-white flex gap-3 justify-center">
            <img src="img/icons/book-light.svg" alt="">
            <p class="font-bold">Selengkapnya</p>
        </button>
    </div>
    <div class="border border-gray-300 p-5 pb-8 rounded-md w-full md:w-1/3 flex flex-col gap-3">
        <h2 class="text-[var(--primary)] text-xl font-bold">Waktu Operasional</h2>
        <div class="flex flex-col w-full">
            <p class="font-bold">Senin - Kamis</p>
            <div class="flex justify-between items-center gap-3 w-full">
                <div class="flex flex-col">
                    <p class="text-sm">Buka</p>
                    <p class="font-bold">07.30 WIB</p>
                </div>
                <div class="flex flex-col">
                    <p class="text-sm">Istirahat</p>
                    <p class="font-bold">11.00 - 14.00 WIB</p>
                </div>
                <div class="flex flex-col">
                    <p class="text-sm">Tutup</p>
                    <p class="font-bold">16.00 WIB</p>
                </div>
            </div>
        </div>
        <div class="flex flex-col w-full">
            <p class="font-bold">Jumat</p>
            <div class="flex justify-between items-center gap-3 w-full">
                <div class="flex flex-col">
                    <p class="text-sm">Buka</p>
                    <p class="font-bold">07.30 WIB</p>
