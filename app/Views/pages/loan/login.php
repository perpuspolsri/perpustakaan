...
<div class="w-full h-screen flex justify-around items-center p-5 md:p-0">
    <div class="h-screen hidden md:flex justify-center items-center">
        <div class="flex flex-col gap-8">
            <img src="/img/loan-illustration.svg" alt="" class="w-full">
            <div class="flex flex-col">
                <h1 class="text-5xl font-bold">Peminjaman Mandiri</h1>
                <p class="text-gray-400">UPT Perpustakaan Politeknik Negeri Sriwijaya</p>
            </div>
        </div>
    </div>
    <div class="w-full md:w-1/3 h-screen flex justify-center items-center">
        ...
        <div id="alertMessage" class="hidden"></div>
            ...
            <p class="text-center">Lupa Password? <a href="" class="text-blue-800 text-semibold underline">Reset</a></p>
